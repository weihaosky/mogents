...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default="trans", help='Name of this trial')
        self.parser.add_argument('--vq_name', type=str, default="rvq", help='Name of the rvq model.')
        ...
        self.parser.add_argument('--attnj', action="store_true", help='Perform attention on joints dimension')
        self.parser.add_argument('--attnt', action="store_true", help='Perform attention on time dimension')
