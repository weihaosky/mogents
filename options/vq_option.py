...
def arg_parse(is_train=False):
    ...
    ## vqvae arch
    parser.add_argument("--code_dim1d", type=int, default=512, help="embedding dimension")
    parser.add_argument("--nb_code1d", type=int, default=512, help="nb of embedding")
    parser.add_argument("--code_dim2d", type=int, default=512, help="embedding dimension")
    parser.add_argument("--nb_code2d", type=int, default=512, help="nb of embedding")
    ...
    # parser.add_argument('--vq_name', type=str, default="rvq2", help='Name of this trial')
